...
import tamriel.cyrodiil.champion.thor.jaxb.Servers.Server;
...
public final class MainTopComponent extends TopComponent {
    ...
    private File xmlFile = new File("C:/devel/storm-manager/thor/NimbusServers.xml");
    ...
    public void deleteServer(NimbusServerNode nsNode) {
        ...
        try {
            for (Server s : _servers.getServer()) {
    ...
    private void saveServer(NimbusServerNode nsNode) {
        try {

            Server nsServer = new Server();
